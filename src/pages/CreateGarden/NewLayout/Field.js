...
export default function Field({ selectedItems, setSelectedItems, fieldWidth, items }) {
    ...
    const [isVegetablesForEditVisible, setIsVegetablesForeEditVisible] = useState(false)
    const [rowToChange, setRowToChange] = useState(null)
    const classes = useStyles();

    useEffect(function updateRemainingSpace() {
        let sumWidths = 0;
    ...
    function handleVegetableForEditDisplayChange(index) {
        ...
        setIsVegetablesForeEditVisible(!isVegetablesForEditVisible)
    }
    ...
    return (
        <Container maxWidth="md" align="center">
            <div className={classes.rowsContainer}>
                {selectedItems.map((item, index) =>
                    <ColumnLayout
                        ...
                        <Column
                            ...
                            handleVegetableForEditDisplayChange={handleVegetableForEditDisplayChange}
                ...
                {remainingSpace > 0 ?
                    <>
                        <Typography variant='h7'>Pozostałe miejsce {remainingSpace}cm</Typography>
                        <IconButton
            ...
            <Typography
                ...
                variant="h5">Szerokość powierzchni - {fieldWidth}cm
            </Typography>
        </Container >
    )
}